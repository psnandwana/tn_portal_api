<?php
namespace App\Controller\Staging;
...
use RestApi\Controller\ApistagingController;
use RestApi\Utility\JwtToken;

if (!isset($_SESSION)) {
    session_start();
}
class WebserviceController extends ApistagingController
{
    ...
    public $front_url = 'http://localhost:4200/dashboard/';
